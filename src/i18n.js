...
const en = {
  ...
  'layout.footerCostLink': 'What the paid tiers cost',
  ...
  'home.navChanged': 'What changed',
  'home.changedEyebrow': 'Re-checked {date}',
  'home.changedHeading': 'What changed since the last review',
  // 「免费额度没了」的下一个问题不是「换哪一家」,是「那现在要花多少钱」——
  // 换一家的名单就在这一页下面,而价格不在。
  'home.changedAfter': 'A free tier closing turns into a bill. What the paid ones actually cost, per million tokens, with the sentence each figure came from:',
  'home.changedAfterLink': 'the field notes cost table',
  'home.changedHistory': 'Every week on record, as JSON',
...
const zh = {
  ...
  'layout.footerCostLink': '付费那几家实际多少钱',
  ...
  'home.navModels': '模型',
  'home.navChanged': '最近变化',
  'home.changedEyebrow': '{date} 重新核对',
  'home.changedHeading': '上次核对之后有什么变化',
  'home.changedAfter': '一条免费通道关掉,就变成一笔账单。付费的那几家每百万 token 实际多少钱、每个数字出自哪一句话：',
  'home.changedAfterLink': '实地记录里的成本表',
  'home.changedHistory': '记录在案的每一周,JSON 格式',

...
一条免费通道关掉,就变成一笔账单 —— 而这份清单到免费额度为止。付费的那几家每百万 token 实际多少钱、每个数字出自哪一句话:[实地记录里的成本表](${fieldNotesUrl('zh')})。
...
- [AI Coding Field Notes](${fieldNotesUrl('zh')}) 把引用过的每一个带单位的数字都发成了 [JSON 和 CSV](https://cdn.jsdelivr.net/gh/xyzs996/llm-api-pricing@main/data/figures.json)，每一行都带着它出处的那句话，后面是对应的长文。
